...
<?php
	...
	if(isset($_GET['xac_nhan_hoa_don']))
	{
		include("chuc_nang/hoa_don/xac_nhan_hoa_don.php");
		trang_truoc_html();
	}
	...
	if(isset($_POST['bieu_mau_them_tin_tuc']))
	{
		include("chuc_nang/tin_tuc/them_tin_tuc_vao_csdl.php");
		trang_truoc_html();
	}
	if(isset($_POST['bieu_mau_sua_tin_tuc']))
	{
		include("chuc_nang/tin_tuc/sua_tin_tuc_o_trong_csdl.php");
	}
	if(isset($_GET['xoa_tin_tuc']))
	{
		include("chuc_nang/tin_tuc/xoa_tin_tuc.php");
		trang_truoc_html();
	}	
