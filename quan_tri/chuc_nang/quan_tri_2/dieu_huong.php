...
<?php 
	...
	switch($thamso)
	{
		...
		break;
		case "tin_tuc":
			include("chuc_nang/tin_tuc/lien_ket_tin_tuc.php");
		break;
		case "them_tin_tuc":
			include("chuc_nang/tin_tuc/them_tin_tuc.php");
		break;
		case "quan_ly_tin_tuc":
			include("chuc_nang/tin_tuc/quan_ly_tin_tuc.php");
		break;
		case "sua_tin_tuc":
			include("chuc_nang/tin_tuc/sua_tin_tuc.php");
		break;
		case "khac":
			include("chuc_nang/khac/khac.php");
		break;
		default: 
